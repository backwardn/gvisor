...
//
// This is effectively a sanity check that prevents a client over a single
// connection from negotiating an absurd number of channels and consuming
// server resources beyond reason. This number is bound by the above const.
